...
public class ConfigTest {
  public static class FfwdSettings {
    ...
    public void httpConfigWithFlush() {
      String json =
          "{\"ffwd\":{\"type\":\"http\",\"flush\":\"true\",\"discovery\":{\"type\":\"srv\","
          + "\"record\":\"hello\"}}}";
      FfwdConfig config = FfwdConfig.fromConfig(conf(json));
